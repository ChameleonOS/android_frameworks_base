...
public class QuickStatsContainerView extends FrameLayout {
    ...
    public QuickStatsContainerView(Context context) {
        this(context, null);
    }

    public QuickStatsContainerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public QuickStatsContainerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    void updateResources() {
        ...
        mCellGap = r.getDimension(R.dimen.quick_stats_cell_gap);
        mNumColumns = r.getInteger(R.integer.quick_stats_num_columns);
        requestLayout();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mSingleRow) {
            ...
            cellHeight = (int) getResources().getDimension(R.dimen.quick_stats_cell_height);
        }
        ...
        for (int i = 0; i < N; ++i) {
            ...
            QuickStatsTileView v = (QuickStatsTileView) getChildAt(i);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < N; ++i) {
            QuickStatsTileView child = (QuickStatsTileView) getChildAt(i);
