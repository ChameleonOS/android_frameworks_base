...
public class PieBatteryView extends BaseBatteryView {
    ...
    private RectF   mRectInner;     // contains the precalculated rect used in drawArc(), derived from mCircleSize
     ...
     */
    public PieBatteryView(Context context) {
        this(context, null);
    }

    public PieBatteryView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PieBatteryView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initSizeBasedStuff() {
        ...
        mPaintFont.setTextSize(mCircleSize / 1.5f);

        // calculate rectangle for drawArc calls
        int pLeft = getPaddingLeft();
        mRectLeft = new RectF(pLeft, 0,
                mCircleSize + pLeft, mCircleSize);
        ...
        mRectInner = new RectF(mRectLeft.left + innerPadding, mRectLeft.top + innerPadding,
                mRectLeft.right - innerPadding, mRectLeft.bottom - innerPadding);
        ...
        mTextY = mCircleSize / 2.0f + (bounds.bottom - bounds.top) / 2.0f + 1;
